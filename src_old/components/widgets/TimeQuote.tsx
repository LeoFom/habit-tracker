  ...
  return (
    <div className="col-span-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
      ...
      <div className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] shadow-[var(--shadow-sm)] border border-[var(--color-border-light)] p-5 transition-all hover:shadow-[var(--shadow-md)] flex items-center gap-4">
        <div className="w-14 h-14 bg-[var(--color-primary-bg)] text-[var(--color-primary)] rounded-[var(--radius-lg)] flex items-center justify-center text-2xl font-bold flex-shrink-0">
          {dayNum}
        </div>
        <div className="flex-1">
          <div className="text-sm text-[var(--color-text-secondary)] capitalize leading-tight">{dayOfWeek},</div>
          <div className="text-xl font-bold text-[var(--color-text-primary)] capitalize leading-tight">{month}</div>
        </div>
